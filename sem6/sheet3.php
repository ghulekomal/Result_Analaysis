...
include("/table.php");
$i=0;
$sql11=mysql_query("SELECT * from ty where avg< 100 order by avg desc limit 2 ");
...
$j=0;
$sqle1=mysql_query("SELECT * from ty1 where avg< 100 order by avg desc limit 2 ");
while($rese1=mysql_fetch_array($sqle1))
{
$name2[$j]=$rese1["candidate_name"];
$sum2[$j]=$rese1["sum"];
$avg2[$j]=$rese1["avg"];
$j=$j+1;
}
...
<tr>
	<td>winter :</td>
	<td>I</td>
	<td><?php echo $name2[0]; ?></td>
	<td><?php echo $sum2[0];?></td>
	<td><?php echo round($avg2[0],2); ?></td>
</tr>
<tr>
	<td></td>
	<td>II</td>
	<td><?php echo $name2[1]; ?></td>
	<td><?php echo $sum2[1];?></td>
	<td><?php echo round($avg2[1],2); ?></td>
</tr>
</table>
...
<tr>
	...
	<td>I</td>
	<td> <?php echo $name1[0]; ?></td>
	<td><?php echo $tot_sum1; ?></td>
	<td><?php echo round($tot_avg1,2); ?></td>
...
<tr>
	...
	<td>II</td>
	<td> <?php echo $name1[1]; ?></td>
	<td><?php echo $tot_sum2; ?></td>
	<td><?php echo round($tot_avg2,2); ?></td>
